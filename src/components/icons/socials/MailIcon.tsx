export default function MailIcon(props: { className?: string }) {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={props.className}>
        <g fill="none">
            <path opacity=".3" d="M20 6H4l8 4.99L20 6zM4 8v10h16V8l-8 5-8-5z" fill="#ffffff"></path>
            <path
