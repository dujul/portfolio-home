export default function AndroidIcon(props: { className?: string }) {
    return <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className={props.className}>
        <linearGradient id="r4wzZI4nTYpRSYqL7WQ95a" x1="37" x2="37" y1="14.5" y2="19.332" gradientUnits="userSpaceOnUse" spreadMethod="reflect">
