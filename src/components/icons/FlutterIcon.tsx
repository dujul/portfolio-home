...
export default function FlutterIcon(props: { className?: string }) {
    return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <g><polygon className="st0" points="157.67,0 0,157.67 48.8,206.47 255.27,0"/>
            ...
            <polygon className="st3" points="71.6,230.36 120.4,181.56 169.84,230.82 121.13,279.53"/>
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-173.6875" y1="548.7979" x2="-172.968"
                y2="548.5386" gradientTransform="matrix(44.5891 0 0 -44.5901 7866.5254 24720.502)"><stop offset="0"/>
                <stop offset="1"/></linearGradient>
            <polygon className="st1" points="121.13,279.53 161.69,266.07 165.72,234.94"/></g>
    </svg>
}